...
router.patch("/update/:id_utilisateur", upload.single('image'),studentController.updateStudent);
router.delete("/delete/:id_utilisateur",studentController.deleteStudent);
