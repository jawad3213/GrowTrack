...
// consoleErrorSpy is set up per test in beforeEach to survive vi.restoreAllMocks()
let consoleErrorSpy
...
describe('ContactUs Component - contactUs function', () => {
  ...
  beforeEach(() => {
    ...
    // Re-spy on console.error each time (since afterEach restores it)
    consoleErrorSpy = vi.spyOn(console, 'error').mockImplementation(() => {})
    
    // Clear all mocks
    vi.clearAllMocks()
    
    // Re-spy after clearAllMocks (clearAllMocks resets the spy's call history)
    consoleErrorSpy = vi.spyOn(console, 'error').mockImplementation(() => {})
