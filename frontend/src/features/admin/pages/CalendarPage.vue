<template>
  <AdminLayout>
    <PageHeader title="Calendar" subtitle="Manage events and schedules">
      <template #actions>
        <SaaSButton variant="primary" @click="openModal">
          <template #icon-left>
...
<button
  ...
  class="flex w-full justify-center rounded-md border border-red-500 bg-red-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 transition sm:w-auto"
>
  🗑 Delete Event
</button>
