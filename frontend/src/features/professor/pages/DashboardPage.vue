...
import EcommerceMetricsProf from '@/components/charts/EcommerceMetricsProf.vue'
import MonthlyTargetProf from '@/components/charts/MonthlyTargetProf.vue'
import MonthlySaleProf from '@/components/charts/MonthlySaleProf.vue'
import DailyStudentProf from '@/components/charts/DailyStudentProf.vue'
import GeneratePdf from '@/features/professor/pages/GeneratePdfPage.vue'
