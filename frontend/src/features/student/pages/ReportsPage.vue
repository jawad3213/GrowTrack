      ...
      <details class="mb-4">
        ...
        <div class="mt-10 mb-10">
          <table class="w-full text-sm border">
            ...
            <tbody>
              <tr v-for="sig in paginatedSignals" :key="sig.id" class="text-center border-t">
...
onMounted(async () => {
  try {
    ...
    evaluations.value.completed = evalData.completed
    evaluations.value.received = evalData.received
    evaluations.value.average = evalData.average_score
