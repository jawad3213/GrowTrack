<template>
  <header
    class="sticky top-0 z-30 flex w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-200/80 dark:border-gray-700/50"
  >
...
import NotificationMenuProf from './header/NotificationMenuProf.vue'
